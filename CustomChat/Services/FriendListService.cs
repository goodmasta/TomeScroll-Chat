...
public sealed unsafe class FriendListService
{
    ...
    public bool? IsOnline(string name, string world)
    {
        ...
        {
            log.Warning(ex, "CustomChat: online-status lookup failed for {Name}@{World}", name, world);
            return null;
        }
    }
    ...
    public void RequestRefresh()
    {
        ...
        {
            log.Warning(ex, "CustomChat: failed to request fresh friend list data");
        }
    }
    ...
    public List<(string Key, string DisplayName)> GetAllFriends()
    {
        ...
        {
            log.Warning(ex, "CustomChat: failed to enumerate the friend list");
        }
