...
public sealed unsafe class NativeChatInputWatcher : IDisposable
{
    ...
    private void OnFrameworkUpdate(IFramework _)
    {
        ...
        log.Debug("TomeScrollChat: native slash input detected - '{Raw}' redirected to plugin input", raw);
    ...
    private void HandleTell(AddonChatLog* addon, Match match, string raw)
    {
        ...
        log.Debug("TomeScrollChat: native tell input detected - '{Raw}' -> {Key}", raw, key);
