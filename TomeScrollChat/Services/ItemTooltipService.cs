...
public sealed unsafe class ItemTooltipService
{
    ...
    private void Open(uint rawItemId, ItemKind kind)
    {
        ...
        {
            log.Warning(ex, "TomeScrollChat: failed to open the native item tooltip for item {ItemId}", rawItemId);
        }
    }
    ...
    private void UpdatePosition()
    {
        ...
        {
            log.Warning(ex, "TomeScrollChat: failed to reposition the native item tooltip");
        }
    }
    ...
    private void Close()
    {
        ...
        {
            log.Warning(ex, "TomeScrollChat: failed to close the native item tooltip");
        }
        finally
        {
            openRawItemId = 0;
