...
public sealed unsafe class ItemContextService
{
    ...
    public void SearchForItem(uint baseItemId)
    {
        ...
        {
            log.Warning(ex, "TomeScrollChat: failed to open item search for item {ItemId}", baseItemId);
        }
    }
    ...
    public void SearchForRecipesUsingItem(uint baseItemId)
    {
        ...
        {
            log.Warning(ex, "TomeScrollChat: failed to open recipe search for item {ItemId}", baseItemId);
        }
    }
}
